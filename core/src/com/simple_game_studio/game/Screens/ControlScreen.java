...
public class ControlScreen implements Disposable{
    public Stage stage;
    ...
    public ControlScreen(SpriteBatch sb) {
        ...
        /**CREATING BUTTONS*/
        buttonsAtlas = new TextureAtlas("images/buttons/packs/button_move.pack"); //** button atlas image **//
        buttonSkin = new Skin();
